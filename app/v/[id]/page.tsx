...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokeptantejilbab.pages.dev/v/${file.filecode}`,
